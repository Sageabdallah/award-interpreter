export const PROMPT_VERSION = 'explain-risk-2'
...
Rules:
- First explain WHAT is going on in 2-3 short plain-English sentences (under 60 words total): what the system found and which numbers matter. Do not restate figures the user can already see unless they are central to the finding.
- Then explain WHY this is a risk in 1-2 sentences (under 40 words total): what obligation is at stake and what could go wrong if it is ignored (underpayment exposure, breach of the award's minimum conditions, audit findings).
- Write for a payroll manager scanning quickly — short sentences, no preamble, no hedging.
